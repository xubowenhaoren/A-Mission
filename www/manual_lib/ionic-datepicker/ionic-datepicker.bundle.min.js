"undefined" != typeof document && function (e, t) {
  ...
  try {
    t = angular.module("ionic-datepicker.templates")
  } catch (e) {
    t = angular.module("ionic-datepicker.templates", [])
  }
  ...
  this.configDatePicker = function (e) {
    angular.extend(s, e)
  }, this.$get = ["$rootScope", "$ionicPopup", "$ionicModal", "IonicDatepickerService", function (e, n, t, r) {
    var a = {}, l = e.$new();
    ...
    l.today = p(new Date).getTime(), l.disabledDates = [], l.data = {}, l.prevMonth = function () {
      1 === l.currentDate.getMonth() && l.currentDate.setFullYear(l.currentDate.getFullYear()), l.currentDate.setMonth(l.currentDate.getMonth() - 1), l.data.currentMonth = l.mainObj.monthsList[l.currentDate.getMonth()], l.data.currentYear = l.currentDate.getFullYear(), i(l.currentDate), o()
    }, l.nextMonth = function () {
      11 === l.currentDate.getMonth() && l.currentDate.setFullYear(l.currentDate.getFullYear()), l.currentDate.setDate(1), l.currentDate.setMonth(l.currentDate.getMonth() + 1), l.data.currentMonth = l.mainObj.monthsList[l.currentDate.getMonth()], l.data.currentYear = l.currentDate.getFullYear(), l.monthChanged(l.currentDate.getMonth()), i(new Date), o()
    };
    var o = function () {
      var e = new Date(l.selctedDateEpoch);
      e.setMonth(l.currentDate.getMonth()), e.setYear(l.currentDate.getFullYear()), l.selctedDateEpoch = e.getTime(), l.mainObj.callback(l.selctedDateEpoch)
    };

    function i(e) {
      e = p(e), l.currentDate = angular.copy(e);
      var t, n, a = new Date(e.getFullYear(), e.getMonth(), 1).getDate(),
        o = new Date(e.getFullYear(), e.getMonth() + 1, 0).getDate();
      l.monthsList = [], l.mainObj.monthsList && 12 === l.mainObj.monthsList.length ? l.monthsList = l.mainObj.monthsList : l.monthsList = r.monthsList, l.yearsList = r.getYearsList(l.mainObj.from, l.mainObj.to), l.dayList = [], l.firstDayEpoch = p(new Date(e.getFullYear(), e.getMonth(), a)).getTime(), l.lastDayEpoch = p(new Date(e.getFullYear(), e.getMonth(), o)).getTime();
      for (var i = a; i <= o; i++) n = (t = new Date(e.getFullYear(), e.getMonth(), i)).getTime() < l.fromDate || t.getTime() > l.toDate || 0 <= l.mainObj.disableWeekdays.indexOf(t.getDay()), l.dayList.push({
        date: t.getDate(),
        month: t.getMonth(),
        year: t.getFullYear(),
        day: t.getDay(),
      ...
      for (var c = (c = l.dayList[0].day - l.mainObj.mondayFirst) < 0 ? 6 : c, d = 0; d < c; d++) l.dayList.unshift({});
      l.rows = [0, 7, 14, 21, 28, 35], l.cols = [0, 1, 2, 3, 4, 5, 6], l.data.currentMonth = l.mainObj.monthsList[e.getMonth()], l.data.currentYear = e.getFullYear(), l.data.currentMonthSelected = angular.copy(l.data.currentMonth), l.currentYearSelected = angular.copy(l.data.currentYear), l.numColumns = 7
    }

    function c(e) {
      var t;
      l.mainObj = angular.copy(e), l.selctedDateEpoch = p(l.mainObj.inputDate).getTime(), l.mainObj.weeksList && 7 === l.mainObj.weeksList.length ? l.weeksList = l.mainObj.weeksList : l.weeksList = ["S", "M", "T", "W", "T", "F", "S"], l.mainObj.mondayFirst && l.weeksList.push(l.mainObj.weeksList.shift()), l.disableWeekdays = l.mainObj.disableWeekdays, i(l.mainObj.inputDate), (t = l.mainObj).disabledDates && 0 !== t.disabledDates.length ? (l.disabledDates = [], angular.forEach(t.disabledDates, function (e, t) {
        e = p(new Date(e)), l.disabledDates.push(e.getTime())
      })) : l.disabledDates = []
    }
    ...
    return l.dateSelected = function (e) {
      e && 0 !== Object.keys(e).length && (l.selctedDateEpoch = e.epoch, l.mainObj.closeOnSelect && (l.mainObj.callback(l.selctedDateEpoch), "popup" == l.mainObj.templateType.toLowerCase() ? l.popup.close() : d()))
    }, l.setIonicDatePickerTodayDate = function () {
      l.dateSelected(l.today)
    }, l.setIonicDatePickerDate = function () {
      l.mainObj.callback(l.selctedDateEpoch), d()
    }, l.monthChanged = function (e) {
      var t = l.monthsList.indexOf(e);
      l.currentDate.setMonth(t), i(l.currentDate), o()
    }, l.yearChanged = function (e) {
      l.currentDate.setFullYear(e), i(l.currentDate), o()
    }, t.fromTemplateUrl("ionic-datepicker-modal.html", {scope: l, animation: "slide-in-up"}).then(function (e) {
      l.modal = e
    }), l.$on("$destroy", function () {
      l.modal.remove()
    }), l.closeIonicDatePickerModal = function () {
      d()
    }, a.openDatePicker = function (e) {
      var t = [];
      delete l.fromDate, delete l.toDate, l.today = p(new Date).getTime(), l.mainObj = angular.extend({}, s, e), l.mainObj.from && (l.fromDate = p(new Date(l.mainObj.from)).getTime()), l.mainObj.to && (l.toDate = p(new Date(l.mainObj.to)).getTime()), e.disableWeekdays && s.disableWeekdays && (l.mainObj.disableWeekdays = e.disableWeekdays.concat(s.disableWeekdays)), c(l.mainObj), l.mainObj.closeOnSelect || (t = [{
        text: l.mainObj.setLabel,
        type: "button_set",
        onTap: function (e) {
          l.mainObj.callback(l.selctedDateEpoch)
        }
      }]), l.mainObj.showTodayButton && t.push({
        text: l.mainObj.todayLabel, type: "button_today", onTap: function (e) {
          var t = new Date(l.today), n = {
            date: t.getDate(),
            month: t.getMonth(),
            year: t.getFullYear(),
            day: t.getDay(),
          ...
          l.dateSelected(n), i(new Date), l.selctedDateEpoch = p(t).getTime(), l.mainObj.callback(l.selctedDateEpoch), l.mainObj.closeOnSelect || e.preventDefault()
        }
      }), t.push({
        text: l.mainObj.closeLabel, type: "button_close", onTap: function (e) {
        }
      }), "popup" == l.mainObj.templateType.toLowerCase() ? l.popup = n.show({
  ...
  this.monthsList = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"], this.getYearsList = function (e, t) {
    for (var n = [], a = 1900, o = 2100, a = e ? new Date(e).getFullYear() : a, o = t ? new Date(t).getFullYear() : o, i = a; i <= o; i++) n.push(i);
    return n
  }
});
